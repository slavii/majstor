<section>
    <header>
        <h2 class="text-lg font-semibold text-gray-900">Информация за профила</h2>
        <p class="mt-1 text-sm text-gray-500">Обновете името и имейл адреса си.</p>
    </header>
                ...
                <div>
                    <p class="text-sm mt-2 text-gray-800">
                        ...
                        <button form="send-verification" class="underline text-sm text-blue-600 hover:text-blue-700">
                            Натиснете тук за повторно изпращане.
                        </button>
                    </p>

                    @if (session('status') === 'verification-link-sent')
                        <p class="mt-2 font-medium text-sm text-green-600">
                            Нов линк за потвърждение е изпратен.
                        </p>
                    @endif
                </div>
            @endif
